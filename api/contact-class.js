    ...
    <div style="padding:24px;">
      ...
      ${
        ...
        <tr>
          ...
          <td
            align="right"
            style="padding-top:10px;border-top:1px solid #ddd;color:#ff2d84;"
          >
...
<div style="font-family:Arial,Helvetica,sans-serif;background:#ffffff;padding:20px;color:#000000;">
  ...
  <p style="margin-top:12px;"><strong>Payment receipt is attached.</strong></p>
</div>
`,
  };
